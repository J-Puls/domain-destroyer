export class ParticleRenderer {
    constructor(game) {
        ...
        this.spawn = () => {
            ...
            this.viewFrame.style.top = `${game.mousePos.y - 75 + game.currentWeapon.particleOffset}px`;
            this.viewFrame.style.left = `${game.mousePos.x - 75 + game.currentWeapon.particleOffset}px`;
            ...
            this.spriteRenderer.style.backgroundImage = `url(${game.currentWeapon.sprites.particle[Math.floor(Math.random() * game.currentWeapon.sprites.particle.length)]})`;
